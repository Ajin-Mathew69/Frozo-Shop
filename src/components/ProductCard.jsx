    ...
    <div className="bg-gray-50 rounded-xl shadow-md overflow-hidden hover:shadow-xl transition">
      ...
      <div className="p-4">
        ...
        <p className="text-gray-400 text-sm font-bold mb-3">
          {product.variants?.edges?.[0]?.node?.unitPriceMeasurement?.quantityValue || "Unknown"}
          {(product.variants?.edges?.[0]?.node?.unitPriceMeasurement?.quantityUnit || "Unknown").toLowerCase()}
        </p>
